...
<body>
  ...
  <header class="mobile-header">
    <div class="mobile-header-left">
      <span class="mobile-title">Rental Summary</span>
    </div>
  ...
  <div class="mobile-menu-overlay" id="mobileMenu" onclick="closeMobileMenu(event)">
    <div class="mobile-menu-panel" onclick="event.stopPropagation()">
      ...
      <nav class="mobile-menu-nav">
        ...
        <a href="available-bikes.php" class="mobile-menu-item"><i class="fas fa-bicycle"></i> Available Bikes</a>
        <a href="rental-summary.php" class="mobile-menu-item active"><i class="fas fa-clock-rotate-left"></i> Rental
          Summary</a>
        <a href="complaints.php" class="mobile-menu-item"><i class="fas fa-comment-dots"></i> Complaints</a>
  ...
  <script>
    ...
    document.addEventListener('keydown', function (e) { if (e.key === 'Escape') { hideLogoutModal(); closeMobileMenu(); } });
  </script>
